...
<div class="employee">
    ...
    <form method="POST" class="employee__profile" enctype="multipart/form-data">
        ...
        <textarea name="empDesciption" placeholder="Hello! This is one sentence about us. Read it and replace it with another one."><?php echo $compDesciption;?></textarea>
        <textarea name="empDesciption" placeholder="Mo—Fri 10—20; Sa—Su 10—00"><?php echo $compOpen;?></textarea>
